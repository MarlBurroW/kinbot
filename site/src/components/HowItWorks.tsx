...
const steps = [
  ...
  },
  {
    ...
    icon: MessageCircle,
    title: 'Start talking',
    description: 'Chat through the web UI, Telegram, Discord, Slack, WhatsApp, or Signal. Your Kin answers from any platform, with full context. Come back tomorrow, it remembers everything.',
    detail: '6 messaging platforms. Persistent memory across sessions.',
  ...
  },
  {
    ...
    description: 'Schedule cron jobs, connect webhooks, let your Kins collaborate on tasks. They monitor your services, triage your issues, manage your media library, all on their own.',
    detail: 'Autonomous agents that get things done while you sleep.',
